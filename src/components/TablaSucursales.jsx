...
export default function TablaSucursales() {
  ...
  const handleEditarSucursal = () => {
    setModalEditarSucursal(!modalEditarSucursal);
  };
  return (
    <div className="overflow-x-auto lg:overflow-visible p-4">
      <div className="rounded-lg overflow-hidden shadow-lg">
        <table className="min-w-full bg-white">
          ...
          <tbody>
            <tr className="border-b border-gray-200 hover:bg-gray-100 text-center">
              <td className="py-2 px-4">Sucursal Central</td>
              <td className="py-2 px-4">Ciudad Principal</td>
              <td className="py-2 px-4">08:00 AM</td>
              <td className="py-2 px-4">08:00 PM</td>
              <td className="py-2 px-4">
                <div className="flex justify-center space-x-2">
                  <button className="bg-green-500 text-white px-3 py-1 rounded-md hover:bg-green-600 cursor-pointer hover:text-black">
                    <svg
                  ...
                  <button className="bg-red-500 text-white px-3 py-1 rounded-md hover:bg-red-600 cursor-pointer hover:text-black">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
        ...
        {modalEditarSucursal && (
          <div className="absolute top-0 left-0 w-full h-full bg-[#6563635d] flex items-center justify-center">
            <EditarSucursal handleEditarSucursal={handleEditarSucursal} />
          </div>
        )}
      </div>
    </div>
